...
if [[ "${CROSS_COMPILE_TARGET}" =~ "darwin" ]]; then
  ...
  SHA256="a758eb6341c889b30866df9c9af2db3974fc76e0d644c6ef5685b749f5e15e0b"
  ...
  SHA256="3f741ca98c9c5e8154fcda78459156711759a0613733e41ca93d81be5fd2a4c9"
...
cp -p -L "${NSS_DIST_OBJ_DIR}/lib/libplc4.${EXT}" "${DIST_DIR}/lib"
cp -p -L "${NSS_DIST_OBJ_DIR}/lib/libplds4.${EXT}" "${DIST_DIR}/lib"
cp -p -L "${NSS_DIST_OBJ_DIR}/lib/libnspr4.${EXT}" "${DIST_DIR}/lib"
